...
levels = input("Log levels for subscriber: >>").strip().split()
# 根据输入的监听级别，循环绑定routing_key到exchange中
for level in levels:
    channel.queue_bind(queue=queue_name, exchange="logs", routing_key=level)
